...
class XRDDataHandler:
    ...
    def create_dataloaders(self, train_dataset, val_dataset, test_dataset, batch_size):
        ...
        return train_dataloader, val_dataloader, test_dataloaderrd_data[idx], self.labels[idx]
...
def main():
    ...
    sample_limit = wandb.config.sample_limit
    ...
    # Create labels from 0 to num_classes-1
    labels = torch.arange(0, num_classes, 1)[:len(synth_xrd)]
    ...
    train_dataset, val_dataset, test_dataset = data_handler.prepare_datasets(
        ...
        train_ratio=wandb.config.train_ratio, 
